...
public class TesteOrdenacao {
	...
	public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("----SORT POR NUMERO_DA_CONTA----");
...
//        });
        ...
        lista.forEach( (Conta conta) -> System.out.println(conta+", "+conta.getTitular().getNome()) ); //Lambda

        System.out.println();
        System.out.println("----SORT POR NOME_DO_TITULAR----");
